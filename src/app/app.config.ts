...
import type { ColorScale } from '@primeng/themes';
...
// Brand primary per docs/wms-app/Basic_Design.md §3.2 — single, fixed seed color, no per-tenant override.
export const MaterialPreset = definePreset(Material, {
  semantic: {
    primary: palette('#0969DA') as ColorScale
  }
});
