...
/**
 * Sales charts, top-customer/top-manufacturer stat cards, unpaid-invoices/waiting-offers tables, and monthly
 * metrics - moved verbatim out of dashboard-list (Initiative 4's "New Dashboard" revamp, 2026-07-30), which is
 * now an AI workspace rather than a stats page. No backend changes; same DashboardService calls as before.
 */
@Component({
...
export class StatisticsListComponent implements OnInit, OnDestroy {
  ...
  onPeriodChange(event: any): void {
    ...
    this.selectedStatMonths = selectedValue;
    this.loadLineChart(selectedValue);
  }
