...
export const routes: Routes =  [
  ...
  { path: 'opt-out', component:OptOutComponent},
  {
    path: 'webview/offer',
    loadComponent: () =>
      import('app/components/webview/offer-view/offer-view.component').then((m) => m.OfferViewComponent),
  },
  {
    path: 'webview/invoice',
    loadComponent: () =>
      import('app/components/webview/invoice-view/invoice-view.component').then((m) => m.InvoiceViewComponent),
  },
  {
  ...
  { path: 'sv',component:LayoutComponent,
    ...
    children: [ 
              ...
              {path: 'offer',component:OfferListComponent},
              {
                ...
                loadComponent: () =>
                  import('app/components/offer/offer-detail/offer-detail.component').then((m) => m.OfferDetailComponent),
              },
